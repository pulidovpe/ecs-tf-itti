#################################
## This resource returns a list 
## of all AZ available in the 
...
#################################
## Creates one Elastic IP per AZ 
## (one for each NAT Gateway in each AZ)
#################################
